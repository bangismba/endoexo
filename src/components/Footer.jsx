      ...
      <div className="max-w-6xl mx-auto flex flex-col md:flex-row justify-between items-start md:items-center gap-8">
        ...
        <div>
          ...
          <ul className="text-gray-400 space-y-1">
            <li>General enquiries: <a href="mailto:info@endoxo.com" className="text-blue-500 hover:underline">info@endoexo.io</a></li>
            <li>Investment enquiries: <a href="mailto:info@endoxo.com" className="text-blue-500 hover:underline">invest@endoexo.io</a></li>
